    ...
    return (
        <div className="w-full h-screen flex flex-col">
            <div className="w-full h-full flex flex-auto bg-primary">
                ...
                <div className={`w-[330px] overflow-y-auto shadow-xl fixed z-50 right-0 top-0 bottom-0 ${!isShowRSidebar && 'hidden'} wide:block animate-slide-left flex-none bg-primary`}>
                    <SidebarRight/>
                </div>
            </div>
