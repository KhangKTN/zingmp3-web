    ...
    return(
        <div>
            ...
            <div className="flex h-[40px] items-center border-b-[1px] border-gray-400">
                <NavLink className={({isActive}) => isActive ? act : noAct} to={`${path.NR_SONG}`}>Bài hát</NavLink>
                <NavLink className={({isActive}) => isActive ? act : noAct} to={path.NR_ALBUM}>Album</NavLink>
            </div>
            <div>
                <Outlet/>
            </div>
