...
const ZingChart = () => {
    ...
    return (
        <div className='bg-gradient-to-tr from-[#522173] to-[#672c8d] p-5 rounded-lg mt-12'>
            <h1 className='font-bold bg-gradient-to-r from-orange-400 via-pink-500 to-indigo-400 inline-block text-transparent text-2xl bg-clip-text'>
                #zingchart
            </h1>
            <div className='flex w-full flex-col xl:flex-row h-[90%] my-3'>
                        ...
                        .map((item, index) => (
                            ...
                            >
                                <SongRelease
                                    ...
                                    text={'text-white'}
                                    order={index + 1}
                                    percent={item?.score / chart?.totalScore}
                                    hover={0}
                                />
                            </div>
                        ))}
                    <Link to={path.ZINGCHART}>
                        <button className='outline outline-offset-2 outline-1 mx-auto block hover:bg-[#ffffff73] rounded-full text-white px-5 py-1'>
                            Xem thêm
                        </button>
                    </Link>
                </div>
                <div className='xl:w-[60%] w-full order-1 xl:order-2 relative'>
                    ...
                    <div
                        style={{ top: tooltip.top, left: tooltip.left, opacity: tooltip.opacity, position: 'absolute' }}
